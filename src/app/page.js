    ...
    return (
        <main className={styles.Main}>
            ...
            <section className={styles.perfil}>
                ...
                <h1>
                    Transformando ideias em realidade digital: Produtos, Marcas
                    e Experiências.
                </h1>

                {/* <p>
                    Crio interfaces interativas e responsivas, transformando
                    ideias em experiências digitais incríveis. Tenho habilidades
                    em desenvolvimento, garantindo uma estética atraente e uma
                    experiência de usuário intuitiva. Trabalho de forma
                    colaborativa, buscando sempre entregar resultados de
                    qualidade.
                </p> */}
            </section>
            ...
            <section className={styles.info}>
                <div className={styles.cardInfo}>
                    ...
                    <h2>UX & UI</h2>
                    <p>
                        Projetar interfaces intuitivas, eficientes e agradáveis
                        de usar.
                    </p>
                </div>
